...
:experimental:
:url-github: https://github.com/hyperpolymath/exorcised-nerdctl
:url-gitlab: https://gitlab.com/hyperpolymath/exorcised-nerdctl
:url-bitbucket: https://bitbucket.org/hyperpolymath/exorcised-nerdctl
:url-codeberg: https://codeberg.org/hyperpolymath/exorcised-nerdctl

Containerless container management toolkit
...
exorcised-nerdctl is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
